...
data_5v_nona <- data_5v_nona[c("study_id", setdiff(names(data_5v_nona), "study_id"))] #3250 no NA for five variable methods. Only these people will have HOMA2
...
data_6c_cc_clean <- data_6c_clean[complete.cases(data_6c_clean[,var_sel3]),] # 3192 no NA new DM cases for both 5var and 9 vrar
