...
coef_df.to_csv(path_folder + '/working/processed/dec_an04d_mod_estimated_coefficients_with_ci_clean_0.33.csv', index=False)
...
cov_matrix.to_csv(path_folder + '/working/processed/dec_an04d_mod_covariance_matrix_statsmodels_clean_0.33.csv')
...
metrics_df.to_csv(path_folder + '/working/processed/dec_an04d_mod_performance_at_best_threshold_clean_0.33.csv', index=True)