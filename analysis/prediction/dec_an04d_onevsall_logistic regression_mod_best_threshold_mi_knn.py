...
print(classification_report(y_test, y_test_pred, target_names=['NON-MOD', 'MOD']))
...
coef_df.to_csv(path_folder + '/working/processed/dec_an04d_mod_estimated_coefficients_with_ci_unscaled_0.39.csv', index=False)
...
cov_matrix.to_csv(path_folder + '/working/processed/dec_an04d_mod_covariance_matrix_statsmodels_unscaled_0.39.csv')
...
metrics_df.to_csv(path_folder + '/working/processed/dec_an04d_mod_performance_at_best_threshold_unscaled_0.39.csv', index=True)