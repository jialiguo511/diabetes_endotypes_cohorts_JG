...
coef_df.to_csv(path_folder + '/working/processed/dec_an09_cc_sidd_estimated_coefficients_with_ci_unscaled_j_index.csv', index=False)
...
cov_matrix.to_csv(path_folder + '/working/processed/dec_an09_cc_sidd_covariance_matrix_statsmodels_unscaled_j_index.csv')