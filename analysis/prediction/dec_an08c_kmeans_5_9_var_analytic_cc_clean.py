...
path_imputed = '/Users/zhongyuli/Desktop/python/cluster analysis/dataset/final_dataset_6c_clean_mi_imputed_homa2.csv'

imputed_dataset = pd.read_csv(path_imputed) 

path_cc = '/Users/zhongyuli/Desktop/python/cluster analysis/dataset/final_dataset_6c_cc_clean_homa2.csv'
...
path_folder = '/Users/zhongyuli/Library/CloudStorage/OneDrive-EmoryUniversity/Diabetes Endotypes Project (JV and ZL)'
contingency_table.to_csv(path_folder + '/working/processed/dec_an08c_contingency_table_comparison_clean.csv')