...
# #################### One vs all logistic regression: MARD vs non_MARD ####################
...
print(classification_report(y_test, y_test_pred, target_names=['NON-MARD', 'MARD']))
...
coef_df.to_csv(path_folder + '/working/processed/dec_an04e_mard_estimated_coefficients_with_ci_clean_0.29.csv', index=False)
...
cov_matrix.to_csv(path_folder + '/working/processed/dec_an04e_mard_covariance_matrix_statsmodels_clean_0.29.csv')
...
metrics_df.to_csv(path_folder + '/working/processed/dec_an04e_mard_performance_at_best_threshold_clean_0.29.csv', index=True)