...
coef_df.to_csv(path_folder + '/working/processed/dec_an04e_mard_estimated_coefficients_with_ci_clean_0.32.csv', index=False)
...
cov_matrix.to_csv(path_folder + '/working/processed/dec_an04e_mard_covariance_matrix_statsmodels_clean_0.32.csv')
...
metrics_df.to_csv(path_folder + '/working/processed/dec_an04e_mard_performance_at_best_threshold_clean_0.32.csv', index=True)