...
coef_df.to_csv(path_folder + '/working/processed/dec_an04e_mard_estimated_coefficients_with_ci_unscaled_0.38.csv', index=False)
...
cov_matrix.to_csv(path_folder + '/working/processed/dec_an04e_mard_covariance_matrix_statsmodels_unscaled_0.38.csv')
...
metrics_df.to_csv(path_folder + '/working/processed/dec_an04e_mard_performance_at_best_threshold_unscaled_0.38.csv', index=True)