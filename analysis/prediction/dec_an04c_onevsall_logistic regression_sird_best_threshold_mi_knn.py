...
coef_df.to_csv(path_folder + '/working/processed/dec_an04c_sird_estimated_coefficients_with_ci_unscaled_0.12.csv', index=False)
...
cov_matrix.to_csv(path_folder + '/working/processed/dec_an04c_sird_covariance_matrix_statsmodels_unscaled_0.12.csv')
...
metrics_df.to_csv(path_folder + '/working/processed/dec_an04c_sird_performance_at_best_threshold_unscaled_0.12.csv', index=True)